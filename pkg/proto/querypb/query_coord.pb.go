...
type UpdateIndexRequest struct {
	...
	// Source vchannel of this update. The index-meta cursor is per-vchannel (a DDL ts is only
	// monotonic within one PChannel), so the receiver gates/apply-fans only this vchannel's
	// segments against this vchannel's cursor.
...
func (x *UpdateIndexRequest) GetChannel() string {
	if x != nil {
		return x.Channel
	}
	return ""
...
var file_query_coord_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x42, 0x61, 0x72, 0x72, 0x69, 0x65, 0x72, 0x54, 0x73, 0x22, 0xba,
	...
	0x68, 0x75, 0x70, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x12, 0x18, 0x0a,
	0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x1a, 0x48, 0x0a, 0x08, 0x41, 0x64, 0x64, 0x49, 0x6e,
	...
	0x66, 0x65, 0x72, 0x2a, 0x3d, 0x0a, 0x09, 0x4c, 0x6f, 0x61, 0x64, 0x53, 0x63, 0x6f, 0x70, 0x65,
