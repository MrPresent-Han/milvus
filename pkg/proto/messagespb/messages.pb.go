...
type InsertMessageHeader struct {
	...
	SchemaVerison int64                         `protobuf:"varint,3,opt,name=schema_verison,json=schemaVerison,proto3" json:"schema_verison,omitempty"`
}
...
func (x *InsertMessageHeader) GetSchemaVerison() int64 {
	if x != nil {
...
func (x *SchemaChangeMessageHeader) GetSchemaVerison() int64 {
	if x != nil {
		return x.SchemaVerison
	}
	return 0
...
var file_messages_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x73, 0x63, 0x68, 0x65, 0x6d,
	...
	0x01, 0x28, 0x03, 0x52, 0x0d, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x56, 0x65, 0x72, 0x69, 0x73,
