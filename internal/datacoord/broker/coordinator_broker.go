...
type Broker interface {
	DescribeCollectionInternal(ctx context.Context, collectionID int64, ts uint64) (*milvuspb.DescribeCollectionResponse, error)
...
func (b *coordinatorBroker) DescribeCollectionInternal(ctx context.Context, collectionID int64, ts uint64) (*milvuspb.DescribeCollectionResponse, error) {
