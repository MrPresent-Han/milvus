...
func (_m *MockBroker) GetCollectionSchemaByVersion(ctx context.Context, collectionID int64, schemaVersion int32) (*schemapb.CollectionSchema, error) {
...
// MockBroker_GetCollectionSchemaByVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCollectionSchemaByVersion'
type MockBroker_GetCollectionSchemaByVersion_Call struct {
	*mock.Call
}
...
//   - collectionID int64
//   - schemaVersion int32
func (_e *MockBroker_Expecter) GetCollectionSchemaByVersion(ctx interface{}, collectionID interface{}, schemaVersion interface{}) *MockBroker_GetCollectionSchemaByVersion_Call {
	return &MockBroker_GetCollectionSchemaByVersion_Call{Call: _e.mock.On("GetCollectionSchemaByVersion", ctx, collectionID, schemaVersion)}
}

func (_c *MockBroker_GetCollectionSchemaByVersion_Call) Run(run func(ctx context.Context, collectionID int64, schemaVersion int32)) *MockBroker_GetCollectionSchemaByVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBroker_GetCollectionSchemaByVersion_Call) Return(_a0 *schemapb.CollectionSchema, _a1 error) *MockBroker_GetCollectionSchemaByVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBroker_GetCollectionSchemaByVersion_Call) RunAndReturn(run func(context.Context, int64, int32) (*schemapb.CollectionSchema, error)) *MockBroker_GetCollectionSchemaByVersion_Call {
	_c.Call.Return(run)
	return _c
}
