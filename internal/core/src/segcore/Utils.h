...
public:
    ...
    MergeBase(std::map<FieldId, std::unique_ptr<milvus::DataArray>>* output_fields_data, size_t offset):
    ...
    milvus::DataArray* get_field_data(FieldId fieldId) const{
...
std::unique_ptr<DataArray>
MergeDataArray(std::vector<MergeBase>& merge_bases, const FieldMeta& field_meta);
