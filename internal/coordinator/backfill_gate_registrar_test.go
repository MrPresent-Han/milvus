...
func TestRegistrar_RegisterWatermark(t *testing.T) {
	...
	require.NoError(t, reg.RegisterWatermark(ctx, 100, 1, []int64{10, 11}, []int64{11}, 3, 42))
	...
	assert.Equal(t, []int64{11}, rounds[0].Scope.VectorFields)
	...
	require.NoError(t, reg.RegisterWatermark(ctx, 100, 2, []int64{10, 11}, []int64{11}, 3, 42))
