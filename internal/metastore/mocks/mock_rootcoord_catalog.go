...
// GetCollectionSchemaByVersion provides a mock function with given fields: ctx, collectionID, schemaVersion
func (_m *RootCoordCatalog) GetCollectionSchemaByVersion(ctx context.Context, collectionID int64, schemaVersion int32) (*schemapb.CollectionSchema, error) {
	ret := _m.Called(ctx, collectionID, schemaVersion)

	if len(ret) == 0 {
		panic("no return value specified for GetCollectionSchemaByVersion")
	}

	var r0 *schemapb.CollectionSchema
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, int32) (*schemapb.CollectionSchema, error)); ok {
		return rf(ctx, collectionID, schemaVersion)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, int32) *schemapb.CollectionSchema); ok {
		r0 = rf(ctx, collectionID, schemaVersion)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, int64, int32) error); ok {
		r1 = rf(ctx, collectionID, schemaVersion)
	} else {
		r1 = ret.Error(1)
	}
...
// RootCoordCatalog_GetCollectionSchemaByVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCollectionSchemaByVersion'
type RootCoordCatalog_GetCollectionSchemaByVersion_Call struct {
	*mock.Call
}

// GetCollectionSchemaByVersion is a helper method to define mock.On call
//   - ctx context.Context
//   - collectionID int64
//   - schemaVersion int32
func (_e *RootCoordCatalog_Expecter) GetCollectionSchemaByVersion(ctx interface{}, collectionID interface{}, schemaVersion interface{}) *RootCoordCatalog_GetCollectionSchemaByVersion_Call {
	return &RootCoordCatalog_GetCollectionSchemaByVersion_Call{Call: _e.mock.On("GetCollectionSchemaByVersion", ctx, collectionID, schemaVersion)}
}

func (_c *RootCoordCatalog_GetCollectionSchemaByVersion_Call) Run(run func(ctx context.Context, collectionID int64, schemaVersion int32)) *RootCoordCatalog_GetCollectionSchemaByVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RootCoordCatalog_GetCollectionSchemaByVersion_Call) Return(_a0 *schemapb.CollectionSchema, _a1 error) *RootCoordCatalog_GetCollectionSchemaByVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RootCoordCatalog_GetCollectionSchemaByVersion_Call) RunAndReturn(run func(context.Context, int64, int32) (*schemapb.CollectionSchema, error)) *RootCoordCatalog_GetCollectionSchemaByVersion_Call {
	_c.Call.Return(run)
	return _c
}
...
// SetupVersionedSchemaStorageIfNeeded provides a mock function with given fields: ctx, coll, ts
func (_m *RootCoordCatalog) SetupVersionedSchemaStorageIfNeeded(ctx context.Context, coll *model.Collection, ts uint64) error {
	ret := _m.Called(ctx, coll, ts)

	if len(ret) == 0 {
		panic("no return value specified for SetupVersionedSchemaStorageIfNeeded")
	}
...
// RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetupVersionedSchemaStorageIfNeeded'
type RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call struct {
	*mock.Call
}

// SetupVersionedSchemaStorageIfNeeded is a helper method to define mock.On call
//   - ctx context.Context
//   - coll *model.Collection
//   - ts uint64
func (_e *RootCoordCatalog_Expecter) SetupVersionedSchemaStorageIfNeeded(ctx interface{}, coll interface{}, ts interface{}) *RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call {
	return &RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call{Call: _e.mock.On("SetupVersionedSchemaStorageIfNeeded", ctx, coll, ts)}
}

func (_c *RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call) Run(run func(ctx context.Context, coll *model.Collection, ts uint64)) *RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.Collection), args[2].(uint64))
	})
	return _c
...
func (_c *RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call) Return(_a0 error) *RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call) RunAndReturn(run func(context.Context, *model.Collection, uint64) error) *RootCoordCatalog_SetupVersionedSchemaStorageIfNeeded_Call {
	_c.Call.Return(run)
	return _c
}
