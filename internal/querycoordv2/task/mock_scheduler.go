...
func (_m *MockScheduler) IsEmpty() chan struct{} {
	ret := _m.Called()
...
// MockScheduler_IsEmpty_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsEmpty'
type MockScheduler_IsEmpty_Call struct {
	*mock.Call
}

// IsEmpty is a helper method to define mock.On call
func (_e *MockScheduler_Expecter) IsEmpty() *MockScheduler_IsEmpty_Call {
	return &MockScheduler_IsEmpty_Call{Call: _e.mock.On("IsEmpty")}
}

func (_c *MockScheduler_IsEmpty_Call) Run(run func()) *MockScheduler_IsEmpty_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockScheduler_IsEmpty_Call) Return(_a0 chan struct{}) *MockScheduler_IsEmpty_Call {
	_c.Call.Return(_a0)
	return _c
}
