...
// GetGlobalMaxSegmentExpireTs provides a mock function with given fields: ctx
func (_m *DataCoordCatalog) GetGlobalMaxSegmentExpireTs(ctx context.Context) (uint64, error) {
	ret := _m.Called(ctx)
...
//   - ctx context.Context
func (_e *DataCoordCatalog_Expecter) GetGlobalMaxSegmentExpireTs(ctx interface{}) *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call {
	return &DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call{Call: _e.mock.On("GetGlobalMaxSegmentExpireTs", ctx)}
}

func (_c *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call) Run(run func(ctx context.Context)) *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call) RunAndReturn(run func(context.Context) (uint64, error)) *DataCoordCatalog_GetGlobalMaxSegmentExpireTs_Call {
	_c.Call.Return(run)
	return _c
}
