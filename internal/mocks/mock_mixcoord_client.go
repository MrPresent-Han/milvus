...
func (_m *MockMixCoordClient) AddCollectionFunctionField(ctx context.Context, in *milvuspb.AddCollectionFunctionFieldRequest, opts ...grpc.CallOption) (*milvuspb.AddCollectionFunctionFieldResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockMixCoordClient_AddCollectionFunctionField_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddCollectionFunctionField'
type MockMixCoordClient_AddCollectionFunctionField_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockMixCoordClient_Expecter) AddCollectionFunctionField(ctx interface{}, in interface{}, opts ...interface{}) *MockMixCoordClient_AddCollectionFunctionField_Call {
	return &MockMixCoordClient_AddCollectionFunctionField_Call{Call: _e.mock.On("AddCollectionFunctionField",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockMixCoordClient_AddCollectionFunctionField_Call) Run(run func(ctx context.Context, in *milvuspb.AddCollectionFunctionFieldRequest, opts ...grpc.CallOption)) *MockMixCoordClient_AddCollectionFunctionField_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockMixCoordClient_AddCollectionFunctionField_Call) Return(_a0 *milvuspb.AddCollectionFunctionFieldResponse, _a1 error) *MockMixCoordClient_AddCollectionFunctionField_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_AddCollectionFunctionField_Call) RunAndReturn(run func(context.Context, *milvuspb.AddCollectionFunctionFieldRequest, ...grpc.CallOption) (*milvuspb.AddCollectionFunctionFieldResponse, error)) *MockMixCoordClient_AddCollectionFunctionField_Call {
	_c.Call.Return(run)
	return _c
}
