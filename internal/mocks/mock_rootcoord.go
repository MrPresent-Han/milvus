...
func (_m *MockRootCoord) AddCollectionFunctionField(_a0 context.Context, _a1 *milvuspb.AddCollectionFunctionFieldRequest) (*milvuspb.AddCollectionFunctionFieldResponse, error) {
	ret := _m.Called(_a0, _a1)
...
// MockRootCoord_AddCollectionFunctionField_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddCollectionFunctionField'
type MockRootCoord_AddCollectionFunctionField_Call struct {
	*mock.Call
}
...
func (_e *MockRootCoord_Expecter) AddCollectionFunctionField(_a0 interface{}, _a1 interface{}) *MockRootCoord_AddCollectionFunctionField_Call {
	return &MockRootCoord_AddCollectionFunctionField_Call{Call: _e.mock.On("AddCollectionFunctionField", _a0, _a1)}
}

func (_c *MockRootCoord_AddCollectionFunctionField_Call) Run(run func(_a0 context.Context, _a1 *milvuspb.AddCollectionFunctionFieldRequest)) *MockRootCoord_AddCollectionFunctionField_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRootCoord_AddCollectionFunctionField_Call) Return(_a0 *milvuspb.AddCollectionFunctionFieldResponse, _a1 error) *MockRootCoord_AddCollectionFunctionField_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRootCoord_AddCollectionFunctionField_Call) RunAndReturn(run func(context.Context, *milvuspb.AddCollectionFunctionFieldRequest) (*milvuspb.AddCollectionFunctionFieldResponse, error)) *MockRootCoord_AddCollectionFunctionField_Call {
	_c.Call.Return(run)
	return _c
}
